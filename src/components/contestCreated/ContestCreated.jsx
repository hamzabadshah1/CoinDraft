...
const ContestCreated = () => {
    return (
        <>
            <Stack bg={"#050826"} minH={"100vh"} px={{ base: '2', sm: '12' }} py={{ base: '12', md: '4' }} spacing={{ base: '6' }} align={'center'} justify={{ base: 'space-between', md: 'center' }}>
                {/* Contest Created Header */}
                <Stack >
                    <Stack w={"full"} align={{ base: 'end', md: 'center' }} justify={{ base: 'space-between', md: 'end' }}>
                        <Image
                ...
                <Stack align={'center'}>
                    ...
                    <Stack>
                        <Text textAlign={'center'} color={'white'}>Invite Contestants</Text>
                    ...
                    {/* Done Button */}
                    <Button _hover={{}} _active={{}} _focus={{}} w={{ base: '44' }} borderRadius={'full'} fontWeight={'bold'} bgGradient='linear(180deg, #FCFF00 10%, #3FFF13 100%)'>Done</Button>
                </Stack>
            </Stack>
        </>
    )
